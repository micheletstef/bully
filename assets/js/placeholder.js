  ...
  <body>
    ...
    <script>
      ...
      async function renderPartition(container, sources, partitionKey) {
        ...
        const appliedPadTB = verticalFlow ? scaledPadding.padLeftRight : scaledPadding.padTopBottom;
        const appliedPadLR = verticalFlow ? scaledPadding.padTopBottom : scaledPadding.padLeftRight;
        ...
        container.style.paddingTop = Math.max(0, Number(appliedPadTB) || 0) + "px";
        container.style.paddingBottom = Math.max(0, Number(appliedPadTB) || 0) + "px";
        container.style.paddingLeft = Math.max(0, Number(appliedPadLR) || 0) + "px";
        container.style.paddingRight = Math.max(0, Number(appliedPadLR) || 0) + "px";
